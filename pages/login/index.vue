    ...
    <CardContent>
      <Form class="grid gap-4" @submit="onSubmit">
        <div class="grid gap-2">
          ...
          <div v-if="authUser.emailisCorrect" class="">
...
const avilableEmail = ref("test.email@gmail.com");
...
// ฟังก์ชัน Validate (กฎการตรวจสอบ)
...
const onSubmit = handleSubmit(() => {
  if (email.value === avilableEmail) {
    authUser.emailisCorrect === true;
  }
});
